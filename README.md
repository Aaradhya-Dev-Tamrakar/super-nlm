...
- **Rotating Batch Studio Scheduler:** Queue Cinematic Videos, Audio Overviews, Study Guides, Quizzes, Flashcards, Mindmaps, Infographics, and more in a background multi-account rotating queue. Jobs persist across restarts and retry automatically after quota resets.
